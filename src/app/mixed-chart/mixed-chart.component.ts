...
export class MixedChartComponent implements OnInit {
  ...
  chartData: Chart.ChartData[] = [
    ...
    },
    {
      labels: ['1500', '1600', '1700', '1750', '1800', '1850', '1900', '1950', '1999', '2050'],
      datasets: [{
        data: [3186, 378, 106, 306, 507, 111, 133, 221, 783, 5000].reverse(),
        borderColor: 'blue',
        fill: true
      },
      {
        data: [86, 378, 4106, 306, 507, 111, 1233, 221, 783, 5000],
        borderColor: 'orange',
        fill: true
      },
      {
        data: [378, 106, 306, 507, 1111, 4133, 221, 783, 4000,4500],
        borderColor: 'green',
        fill: true
      },{
        data: [378, 106, 306, 507, 1111, 133, 221, 783, 4000,4500].reverse(),
        borderColor: 'read',
        fill: true
      }
      ]
